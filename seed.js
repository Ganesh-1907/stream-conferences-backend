  ...
  try {
    ...
    for (const def of conferenceDefs) {
      ...
      const doc = await Conference.create({
        ...
        venueAddress: '100 Convention Boulevard',
        eventDate: startDate,
        startDate,
        endDate,
        subdomain: def.slug,
        ...
        organizerContact: { name: def.contact, email: 'organizer@streamconferences.com', phone: '+1 555 010 0000', website: 'https://streamconferences.com', address: '100 Convention Boulevard' },
        ...
        venueDetails: { name: 'Grand Convention Center', address: '100 Convention Boulevard', city: def.location.split(',')[0], country: 'USA', description: 'State-of-the-art conference facility with multiple halls.' },
        announcedBy: 'admin',
